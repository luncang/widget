...
public class CustomTitleBar extends LinearLayout {
    ...
    public CustomTitleBar(Context context, AttributeSet attrs) {
        ...
        title_textSize = typedArray.getDimensionPixelSize(R.styleable.CustomTitleBar_title_textSize, DEFAULT_TITLE_SIZE);
        /**返回按钮相关*/
        left_button_imageId = typedArray.getResourceId(R.styleable.CustomTitleBar_left_button_image, R.mipmap.btn_back_press);
        ...
        left_button_textSize = typedArray.getDimensionPixelSize(R.styleable.CustomTitleBar_left_button_textSize, DEFAULT_UNTITLE_SIZE);
        ...
        right_button_textSize = typedArray.getDimensionPixelSize(R.styleable.CustomTitleBar_right_button_textSize, DEFAULT_UNTITLE_SIZE);
        ...
        if (!TextUtils.isEmpty(right_button_text)) {//保存按钮显示为文字
